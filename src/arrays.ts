//index                           0       1         2        3      4
const myfriendsname: string[] =["Maaz", "Mubashir", "Pushkar", "Zuhaib", "Asad"];
...
let myfriendsnumbers: Array<number|string> = [1,2,3,4,5,6];
...
const myfavouritegirlsname: readonly string[] = ["alina", "saba", "ayesha", "diya"];
...
const mymostfavouritegirlname: string[] = ["saba", "alina", "ayesha", "diya"];
mymostfavouritegirlname[0] ="Ilma"; 

console.log(mymostfavouritegirlname, "line 41");

// this method changes the design to like string
const fruits: string[] = ["banana", "mango", "orange", "peach", "apricot"];
console.log(fruits.toString(), "---string");


//this method give sequence to an array 
const vegetables: string[] = ["palak", "alou", "piyaz", "bhendi", "tori"];
console.log(vegetables.sort(), "sorting");

//this method tell you the lenght of array but it starts counting from 1 and index starts from 0 this is defference between them
const mangoes: string[] = ["chunca", "sindhri", "langra", "desi", "harami"];
